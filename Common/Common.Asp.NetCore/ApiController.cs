...
public  class ApiController: ControllerBase
{
...

    {
        ...
        {
            IsSuccess =isSuccess,
            Data =isSuccess?result.Data:default,//میگه اگر  ساکسس فالس بود بیا مقدار پیشفرض همون تی دیتا رو بزار یجور نال هستش
    ...
    protected string JoinErrors()
    {
        ...
        if (!ModelState.IsValid)
        {
            if (ModelState.ErrorCount > 0)
            {
                ...
                {
                    var key = ModelState.Keys.ElementAt<string>(i);
