...
public class GetShippingMethodsByListQuery : IBaseQuery<List<ShippingMethodDto>>
{

}

internal class GetShippingMethodsByListQueryHandler : IBaseQueryHandler<GetShippingMethodsByListQuery, List<ShippingMethodDto>>
{
