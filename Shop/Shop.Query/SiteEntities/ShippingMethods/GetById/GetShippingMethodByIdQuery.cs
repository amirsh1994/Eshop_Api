...
public record GetShippingMethodByIdQuery(long Id) : IBaseQuery<ShippingMethodDto?>;

public class GetShippingMethodByIdQueryHandler : IBaseQueryHandler<GetShippingMethodByIdQuery, ShippingMethodDto?>
{
